...
const setActions = (fn, prefix, fnName = fn.name, metaInfo) => {
  ...
  fn._successType = actionName + _constants.SUCCESS_TYPE;
  fn._busyType = actionName + _constants.BUSY_TYPE;
  fn._errorType = actionName + _constants.ERROR_TYPE;
  fn._cancellationType = actionName + _constants.CANCEL_TYPE;
...
function createAction(fn, fnName = fn.name, { prefix, meta } = {}) {
  if (fn.baseType) {
    return fn;
  }
...
const createActions = exports.createActions = (actions, params) => {
